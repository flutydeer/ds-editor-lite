...
在“选择组件”页面展开“Qt”项目，找到“Qt 6.11.1”（最新版）。勾选以下选项：
...
```sh
set QT_DIR=C:\Qt\6.11.1\msvc2022_64 # 根据实际情况修改
set Qt6_DIR=%QT_DIR%
...
```shell
export QTDIR=/home/OrangeCat/Qt/6.11.1/gcc_64 # 根据实际情况修改
...
```sh
export QT_DIR="/home/OrangeCat/Qt/6.11.1/gcc_64" # 根据实际情况修改
