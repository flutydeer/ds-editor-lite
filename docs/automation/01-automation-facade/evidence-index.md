...
| 证据编号 | 轮次 | 类型 | SHA-256 |
|---|---:|---|---|
| `E-R124-GUI-G04-TRACK-MIXER` | 124 | GUI-G04 轨道属性、颜色联动、排序、Mixer 数值与删除历史验证 | `f7fe6ea5a2ba21b4355538a8c91d6eac78039953c83910ca3e3083fda0d23077` |

## 追加证据 67

| 证据编号 | 轮次 | 类型 | SHA-256 |
|---|---:|---|---|
| `E-R125-GUI-G05-CLIP-EDITING` | 125 | GUI-G05 歌声片段创建、属性、跨轨移动、resize、剪贴板、激活与 Alt 非吸附验证 | `08502b07d83faa671a674134cc2556e2a8649c4a21383e1337ebfc3343133655` |

## 追加证据 68

| 证据编号 | 轮次 | 类型 | SHA-256 |
|---|---:|---|---|
| `E-R126-GUI-G06-NOTE-EDITING` | 126 | GUI-G06 音符选择、移动、重叠、resize、split、量化、删除历史与 Alt 非吸附验证 | `09ce7680345436dec93c83c8cc3f3a513c299328857a2a0dc68598e73b3b4a05` |
...
| 证据编号 | 轮次 | 类型 | SHA-256 |
|---|---:|---|---|
| `E-R143-GUI-G13-HISTORY-FOCUS` | 143 | GUI-G13 History、保存点、焦点回显、二次确认与分支截断 | `3b4ceb214c6115063898a8df585add1ceab72080e802236b02e4f4b665333b23` |

## 追加证据 81

| 证据编号 | 轮次 | 类型 | SHA-256 |
|---|---:|---|---|
| `E-R144-R146-GUI-G14-AUTO-PAGE-RECOVERY` | 144–146 | GUI-G14 Editor 状态、自动翻页缺陷、修复门禁与二向复测 | `4201d664c8d647b60440159306b7c8beaac115d0302654aa4754d9415de8b57a` |
...
| 证据编号 | 轮次 | 类型 | SHA-256 |
|---|---:|---|---|
| `E-R178-R190-GUI-G21-G24-FINAL` | 178–190 | GUI-G21～G24 音频资产、推理/提取、MIDI 导出回读、重启退出与最终恢复 | `46b16dfac506a7681a587b81d418810ddee4bb75794eb1a4d1283f936a967379` |

## 追加证据 90

| 证据编号 | 轮次 | 类型 | SHA-256 |
|---|---:|---|---|
| `E-R191-R194-FINAL-BUILD-CTEST` | 191–194 | 最终 Debug 配置与全目标构建、三轮完整串行 CTest 及稳定性检查 | `099e16d31976cae1553c6695907a7b3ab75a26fb52fc3a5a79067aead873a962` |
