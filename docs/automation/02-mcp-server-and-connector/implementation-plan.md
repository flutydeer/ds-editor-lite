...
公共能力先按业务域建模，再映射到 Profile、MCP descriptor 和 Connector exposure。Editor 的 24 个域依次为：应用、文档与工程、格式、轨道、总线、剪辑、音频剪辑、声库、Speaker Mix、音符/歌词/语言/发音/音素、参数曲线与锚点、时间轴、历史记录、播放、导出、提取、推理、异步任务、工作区布局、轨道面板、剪辑编辑器、设置、包信息、歌词规则。
