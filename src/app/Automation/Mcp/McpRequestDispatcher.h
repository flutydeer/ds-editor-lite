...
namespace Automation {
    ...
    public:
        explicit McpRequestDispatcher(PublicAutomationRegistry &registry,
                                      AutomationWire::Mcp::ImplementationInfo serverInfo);

        [[nodiscard]] QJsonObject dispatch(const AutomationWire::Mcp::RequestEnvelope &request,
                                           const QString &clientId) const;

    private:
        [[nodiscard]] QJsonObject
            dispatchToolsList(const AutomationWire::Mcp::RequestEnvelope &request) const;
        [[nodiscard]] QJsonObject
            dispatchToolsCall(const AutomationWire::Mcp::RequestEnvelope &request,
                              const QString &clientId) const;
