...
inline GpuInfo DmlGpuUtils::getGpuByPciDeviceVendorId(unsigned int pciDeviceId,
...
inline GpuInfo DmlGpuUtils::getGpuByPciDeviceVendorIdString(const QString &idString,
                                                            int indexHint) {
    Q_UNUSED(idString)
    Q_UNUSED(indexHint)
    return {};
