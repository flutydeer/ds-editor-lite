...
namespace FillLyric
{
    ...
    QList<QList<LangNote>> LyricSplitter::splitAuto(const QString &input,
        ...
        const auto tagRes = TextTagger::tag(splitRes, true, priorityLanguages);
        ...
        for (const auto &tagger_res : tagRes) {
            ...
            tempNote.g2pId = QString::fromLatin1(kUnknownG2pId);
    ...
    QList<QList<LangNote>> LyricSplitter::splitByChar(const QString &input,
        ...
        for (size_t i = 0; i < chars.size(); i++) {
            ...
            if (i < taggerRes.size()) {
                note.g2pId = QString::fromLatin1(kUnknownG2pId);
