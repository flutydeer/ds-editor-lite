...
#define AUDIO_AUDIO_SETTINGS_OPTION_IMPLEMENTATION_1(readName, writeName, dtoField)                \
  AUDIO_AUDIO_SETTINGS_OPTION_IMPLEMENTATION_2(                                                    \
      readName, writeName, std::invoke_result<decltype(&AudioSettings::readName)>::type{}, dtoField)
...
#define AUDIO_AUDIO_SETTINGS_OPTION_IMPLEMENTATION_2(readName, writeName, defaultValue, dtoField)  \
  ...
  void AudioSettings::writeName(                                                                   \
    ...
    updateAudioSettings([&v](Automation::AudioSettingsDto &settings) { settings.dtoField = v; });  \
  }
...
#define AUDIO_AUDIO_SETTINGS_OPTION_IMPLEMENTATION_WITH_INDEX_2(                                  \
    readName, writeName, defaultValue, dtoField)                                                   \
...
AUDIO_AUDIO_SETTINGS_OPTION_IMPLEMENTATION_1(playheadBehavior, setPlayheadBehavior, playheadBehavior)

AUDIO_AUDIO_SETTINGS_OPTION_IMPLEMENTATION_2(midiDeviceIndex, setMidiDeviceIndex, -1,
                                              midiDeviceIndex)
AUDIO_AUDIO_SETTINGS_OPTION_IMPLEMENTATION_2(midiSynthesizerAmplitude,
                                              setMidiSynthesizerAmplitude, -9,
                                              midiSynthesizerAmplitude)
...
AUDIO_AUDIO_SETTINGS_OPTION_IMPLEMENTATION_2(midiSynthesizerDecayMsec,
                                              setMidiSynthesizerDecayMsec, 1000,
                                              midiSynthesizerDecayMilliseconds)
...
AUDIO_AUDIO_SETTINGS_OPTION_IMPLEMENTATION_2(midiSynthesizerGenerator,
                                              setMidiSynthesizerGenerator, 3,
                                              midiSynthesizerGenerator)
