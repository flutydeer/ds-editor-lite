...
AUDIO_AUDIO_SETTINGS_OPTION_IMPLEMENTATION_QJSONVALUE(audioExporterCurrentPreset,
                                                      setAudioExporterCurrentPreset)
