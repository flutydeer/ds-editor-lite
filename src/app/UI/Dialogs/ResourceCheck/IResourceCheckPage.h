...
// Page interface of the resource check dialog. One page per resource type (audio files, singer
// packages, etc.), assembled on demand by ResourceCheckDialog; implement this interface to add new
// resource types
