...
namespace FillLyric {
    ...
    TableConfigWidget::TableConfigWidget(QWidget *parent) : QWidget(parent) {
        ...
        m_colWidthRatioLabel = new QLabel(tr("Column Width Ratio"), this);
        ...
        m_rowHeightLabel = new QLabel(tr("Row Height Ratio"), this);
        ...
        m_fontDiffLabel = new QLabel(tr("Font Size Diff"), this);
