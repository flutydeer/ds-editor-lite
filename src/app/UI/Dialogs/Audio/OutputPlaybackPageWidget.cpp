#include "OutputPlaybackPageWidget.h"
...
OutputPlaybackPageWidget::OutputPlaybackPageWidget(QWidget *parent) : QWidget(parent) {
    ...
    fileLayout->addRow(tr("&File reading buffer size (samples)"),
