...
public:
    ...
    static std::optional<SpeakerMixPreset> findPresetByName(const SingerInfo &singerInfo,
                                                            const QString &name);
    static SpeakerMixModel::SpeakerMixData speakerMixDataFromPreset(const SpeakerMixPreset &preset,
    ...
    static std::optional<SpeakerMixPreset>
        sourcePresetForData(const SingerInfo &singerInfo,
                            const SpeakerMixModel::SpeakerMixData &data);
