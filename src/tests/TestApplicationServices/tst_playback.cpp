...
void ApplicationServicesTests::playbackSnapshotAndDocumentIdentity() {
...
void ApplicationServicesTests::playbackTransitionsAreTransient() {
    ApplicationHarness harness;
    auto &runtime = harness.core();
    const auto initialVersion = runtime.documentVersion();
...
void ApplicationServicesTests::playbackStartFailuresPreserveState() {
    ApplicationHarness harness;
    auto &runtime = harness.core();
    const auto initialVersion = runtime.documentVersion();
...
void ApplicationServicesTests::playbackPositionsPreviewAndCommit() {
    ApplicationHarness harness;
    auto &runtime = harness.core();
    const auto initialVersion = runtime.documentVersion();
...
void ApplicationServicesTests::playbackLoopMutationsAndValidation() {
    ApplicationHarness harness;
    auto &runtime = harness.core();
...
void ApplicationServicesTests::playbackCommandGuards() {
    ApplicationHarness harness;
    auto &runtime = harness.core();
...
void ApplicationServicesTests::playbackControlsDuringDocumentWorkflow() {
    ApplicationHarness harness;
    auto &runtime = harness.core();
