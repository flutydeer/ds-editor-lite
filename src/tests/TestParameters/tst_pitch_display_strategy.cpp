...
void ParametersTests::pitchDisplayStrategyDisplayModeMapping() {
    testDisplayModeMapping();
}

void ParametersTests::pitchDisplayStrategyPitchEditModeClassification() {
    testPitchEditModeClassification();
}

void ParametersTests::pitchDisplayStrategyDisplayLayers() {
    testDisplayLayers();
}

void ParametersTests::pitchDisplayStrategyAnchorCoverage() {
    testAnchorCoverage();
}

void ParametersTests::pitchDisplayStrategyCurveSampling() {
    testCurveSampling();
}

void ParametersTests::pitchDisplayStrategyMergedCurveCache() {
