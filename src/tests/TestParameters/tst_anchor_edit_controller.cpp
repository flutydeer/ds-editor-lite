...
void ParametersTests::anchorEditControllerLoadOwnsCopies() {
    testLoadOwnsCopies();
}
...
void ParametersTests::anchorEditControllerCreateClearsOverlappingPreview() {
    testCreateClearsOverlappingPreview();
}

void ParametersTests::anchorEditControllerDragCancelRestoresSnapshot() {
    testDragCancelRestoresSnapshot();
}

void ParametersTests::anchorEditControllerSelectionDeleteAndInterpolation() {
    testSelectionDeleteAndInterpolation();
}

void ParametersTests::anchorEditControllerSwitchingAwayFromProvisionalAllowsCommit() {
    testSwitchingAwayFromProvisionalAllowsCommit();
}

void ParametersTests::anchorEditControllerDeleteToOneRemovesWholeCurve() {
    testDeleteToOneRemovesWholeCurve();
}

void ParametersTests::anchorEditControllerKeyboardCommands() {
    testKeyboardCommands();
}

void ParametersTests::anchorEditControllerCompositionPreservesOtherCurveKind() {
    testCompositionPreservesOtherCurveKind();
}

void ParametersTests::anchorEditControllerCompositionPreservesExistingSinglePointDrawCurves() {
    testCompositionPreservesExistingSinglePointDrawCurves();
}

void ParametersTests::anchorEditControllerCompositionRejectsIncompleteAnchorCurves() {
    testCompositionRejectsIncompleteAnchorCurves();
}

void ParametersTests::anchorEditControllerSelectionAndLastNodeMenu() {
    testSelectionAndLastNodeMenu();
}

void ParametersTests::anchorEditControllerBoundaryClippingAndRejectedMutation() {
    testBoundaryClippingAndRejectedMutation();
}

void ParametersTests::anchorEditControllerTransferAndMerge() {
    testTransferAndMerge();
}

void ParametersTests::anchorEditControllerCallbackOrder() {
    testCallbackOrder();
}

void ParametersTests::anchorEditControllerAnchorSamplesOverrideDrawOnlyInTheirInterval() {
    testAnchorSamplesOverrideDrawOnlyInTheirInterval();
}

void ParametersTests::anchorEditControllerAnchorSamplingDoesNotExtrapolateBeforeFirstNode() {
