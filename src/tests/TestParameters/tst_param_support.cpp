...
void ParametersTests::paramSupportSupportFollowsSynthesisPath() {
    const auto singer =
...
void ParametersTests::paramSupportVarianceBackedParameters() {
...
void ParametersTests::paramSupportEditToolVisibilityFollowsParameterType() {
    ...
    QVERIFY2((isParamEditorEditModeVisible(ParamEditorEditMode::Shape, ParamInfo::Breathiness) &&
...
void ParametersTests::paramSupportUnknownCapabilitiesAreConservative() {
...
void ParametersTests::paramSupportKnownEmptyCapabilities() {
...
void ParametersTests::paramSupportIndependentCapabilitySources() {
    const auto disabled =
...
void ParametersTests::paramSupportPromptStateResetsForEveryProjectOpen() {
