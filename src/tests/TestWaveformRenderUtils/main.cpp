...
class WaveformRenderUtilsTests final : public QObject {
    Q_OBJECT
...
private slots:
    ...
    void amplitudeMapping() {
        ...
        const auto logarithmicQuarter = WaveformRenderUtils::mapAmplitude(
...
QTEST_GUILESS_MAIN(WaveformRenderUtilsTests)
#include "main.moc"
