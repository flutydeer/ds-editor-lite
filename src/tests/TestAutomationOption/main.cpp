...
class TestAutomationOption final : public QObject {
    Q_OBJECT
...
private slots:
    ...
    void defaults() {
        ...
        QVERIFY2((!option.mcpEnabled),
                 qPrintable(QStringLiteral("MCP should default to disabled")));
        QVERIFY2((option.controlPort >= AutomationOption::kRandomControlPortMinimum &&
                 ...
                 qPrintable(QStringLiteral(
                     "the initial configuration should have a concrete private port")));
        ...
        QVERIFY2(
            (!option.customPermissionEnabled(QStringLiteral("notes.list"))),
            qPrintable(QStringLiteral("unknown Custom permissions should default to disabled")));
        QVERIFY2(
            (option.accessRoots == defaultRoots),
    ...
    void roundTrip() {
        ...
        QVERIFY2((reloaded.mcpEnabled),
                 qPrintable(QStringLiteral("MCP setting should round-trip")));
        ...
        QVERIFY2(
            (reloaded.customPermissions.contains(QStringLiteral("documents.save")) &&
    ...
    void controlLevelConversion_data() {
    ...
    void invalidPermissionAndLevelCannotBeEnabled() {
        AutomationOption option;
        ...
        option.load({
            ...
            {QStringLiteral("customPermissions"),
             QJsonObject{{QString{}, true},
                         {QStringLiteral("notes.list"), QStringLiteral("true")}}}
        });
    ...
    void stableGeneratedControlPort() {
        ...
        QVERIFY2((generated.controlPort >= AutomationOption::kRandomControlPortMinimum &&
                  generated.controlPort <= AutomationOption::kRandomControlPortMaximum),
                 qPrintable(QStringLiteral(
                     "missing or legacy zero ports should generate a concrete port")));
        ...
        reloaded.load(saved);
        QVERIFY2(
            (reloaded.controlPort == generated.controlPort),
    ...
    void mcpClientConfigurations() {
        using namespace Automation::McpClientConfiguration;

        QVERIFY2((connectorArguments(AutomationOption::ControlLevel::L2) ==
        ...
        const auto command =
            connectorExecutablePath(QStringLiteral("C:/Program Files/DS Editor Lite"));
        ...
        QVERIFY2(
            (httpServer.value(QStringLiteral("type")).toString() ==
...
QTEST_GUILESS_MAIN(TestAutomationOption)
#include "main.moc"
