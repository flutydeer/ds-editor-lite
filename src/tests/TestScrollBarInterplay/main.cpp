...
class ScrollBarInterplayTests final : public QObject {
    Q_OBJECT
...
private slots:
    ...
    void sceneAttachment() {
        ...
        QVERIFY2((sceneAwareItem.scaleInitializedInScene &&
    ...
    void touchpadAndWheelDelta() {
        QWheelEvent angleWheel(QPointF(10, 10), QPointF(10, 10), {}, QPoint(120, -240),
    ...
    void horizontalAndShiftGestures() {
        ...
        configureScrollTarget(touchPadHorizontalScroll, Qt::Horizontal, touchPadHorizontalValue,
                              1000.0, 38.0);
        ...
        QWheelEvent shiftedWheel(QPointF(10, 10), QPointF(10, 10), {}, QPoint(0, -120),
    ...
    void fractionalAndReversedWheelMotion() {
        ...
        for (int i = 0; i < 2; ++i)
            reversingScroll.handleWheel(&fineWheelDown,
                                        WheelInputController::Action::VerticalScroll, Qt::Vertical);
        for (int i = 0; i < 4; ++i)
    ...
    void pendingWheelTargetsRespectBounds() {
        ...
        QWheelEvent wheelTowardEnd(QPointF(10, 10), QPointF(10, 10), {}, QPoint(0, -120),
                                   Qt::NoButton, Qt::NoModifier, Qt::NoScrollPhase, false);
        QWheelEvent wheelAwayFromEnd(QPointF(10, 10), QPointF(10, 10), {}, QPoint(0, 120),
                                     Qt::NoButton, Qt::NoModifier, Qt::NoScrollPhase, false);
        boundedWheelScroll.handleWheel(&wheelTowardEnd);
        boundedWheelScroll.handleWheel(&wheelTowardEnd);
        boundedWheelScroll.handleWheel(&wheelAwayFromEnd);
        QVERIFY2(
            (boundedWheelScroll.logicalScrollValue(Qt::Vertical) == 80.0),
        ...
        QVERIFY2(
            (resizedWheelScroll.logicalScrollValue(Qt::Vertical) == 30.0),
    ...
    void viewportResizeClamping() {
        ...
        QVERIFY2(
            (qFuzzyCompare(viewport.horizontalOffset(), 300.0) &&
    ...
    void focusReveal() {
        ...
        QVERIFY2((focusViewport.ensureVisible(QRectF(500, 500, 100, 50), 24, 24) &&
                  ...
                  qFuzzyCompare(focusViewport.verticalOffset(), 400.0) &&
                  focusViewportChanges == 0),
        ...
        QVERIFY2((focusViewport.ensureVisible(QRectF(1050, 680, 100, 40), 24, 24) &&
                  ...
                  qFuzzyCompare(focusViewport.verticalOffset(), 444.0) &&
                  focusViewportChanges == 1),
        ...
        QVERIFY2((focusViewport.ensureVisible(QRectF(320, 420, 10, 10), 24, 24) &&
                  ...
                  qFuzzyCompare(focusViewport.verticalOffset(), 396.0) &&
                  focusViewportChanges == 2),
    ...
    void repeatedBoundaryScrollDoesNotNotify() {
        ...
        QObject::connect(&boundedViewport, &EditorViewportController::viewportChanged,
                         &boundedViewport, [&boundedViewportChanges] { ++boundedViewportChanges; });
...
QTEST_MAIN(ScrollBarInterplayTests)
#include "main.moc"
