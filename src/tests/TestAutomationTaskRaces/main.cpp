...
class TestAutomationTaskRaces final : public QObject {
    Q_OBJECT
...
private slots:
    ...
    void documentTaskRetention() {
        ...
        const auto other =
            tasks.createTask(Automation::OperationIds::inference::start, otherDocument);
    ...
    void cancelVersusCommitStress() {
        ...
        for (int iteration = 0; iteration < iterations; ++iteration) {
            ...
            if (commitOutcome.returned && commitOutcome.mayCommit) {
                ++commitWins;
                QVERIFY2((!cancelOutcome.succeeded &&
                          cancelOutcome.error ==
    ...
    void duplicateCompletionStress() {
        ...
        for (int iteration = 0; iteration < iterations; ++iteration) {
            ...
            QVERIFY2((!tasks.fail(task.taskId, Automation::AutomationError{}) &&
                      !tasks.cancel(task.taskId)),
    ...
    void controlledDispatcherCommitBoundary() {
        ...
        qInfo("non-cancelable commit point and one dispatcher commit");
        {
            ...
            QVERIFY2((validation && committing && committing.get() && !lateCancel &&
    ...
    void committingGenerationReplacement() {
        ...
        QVERIFY2(
            (!oldLookup &&
             ...
             !newLookup && newLookup.getError().code == Automation::AutomationErrorCode::NotFound &&
...
QTEST_GUILESS_MAIN(TestAutomationTaskRaces)
