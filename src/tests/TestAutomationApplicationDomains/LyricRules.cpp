...
void TestAutomationApplicationDomains::lyricRuleSnapshotAndPreview() {
...
void TestAutomationApplicationDomains::lyricRuleCreation_data() {
    QTest::addColumn<bool>("tagger");
    QTest::newRow("splitter") << false;
    QTest::newRow("tagger") << true;
}

void TestAutomationApplicationDomains::lyricRuleCreation() {
    QFETCH(bool, tagger);
    ApplicationHarness harness;
    harness.lyricRulesSnapshot = {builtinSplitter()};
...
void TestAutomationApplicationDomains::lyricRuleRename_data() {
    QTest::addColumn<bool>("tagger");
    QTest::newRow("splitter") << false;
    QTest::newRow("tagger") << true;
}

void TestAutomationApplicationDomains::lyricRuleRename() {
    QFETCH(bool, tagger);
    ApplicationHarness harness;
...
void TestAutomationApplicationDomains::lyricRuleEnableAndOrder() {
    ApplicationHarness harness;
...
void TestAutomationApplicationDomains::invalidLyricRuleEdits_data() {
...
void TestAutomationApplicationDomains::invalidLyricRuleEdits() {
    QFETCH(int, scenario);
    ApplicationHarness harness;
...
void TestAutomationApplicationDomains::lyricRuleDeletion_data() {
    QTest::addColumn<bool>("tagger");
    QTest::newRow("splitter") << false;
    QTest::newRow("tagger") << true;
}

void TestAutomationApplicationDomains::lyricRuleDeletion() {
    QFETCH(bool, tagger);
    ApplicationHarness harness;
    const auto rule = seedCustomRule(harness, tagger);
    const auto deleted =
...
void TestAutomationApplicationDomains::lyricRuleHostValidationFailure() {
    ApplicationHarness harness;
    const auto before = harness.settings.fillLyric;
...
void TestAutomationApplicationDomains::lyricRuleTestDelegatesWithoutMutation() {
    ApplicationHarness harness;
...
void TestAutomationApplicationDomains::invalidLyricRulesDoNotPersist() {
    ApplicationHarness harness;
