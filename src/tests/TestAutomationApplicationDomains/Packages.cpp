...
void TestAutomationApplicationDomains::packageVersionAndPathProjection() {
...
void TestAutomationApplicationDomains::packageRefreshPreviewAndResultProjection() {
    ApplicationHarness harness;
    harness.packages = {
        {.id = QStringLiteral("voice.package"),
         .version = QVersionNumber(1, 0),
...
void TestAutomationApplicationDomains::packageSearchPaths() {
    ApplicationHarness harness;
    auto &runtime = harness.core();
...
void TestAutomationApplicationDomains::packages() {
    ApplicationHarness harness;
    auto &runtime = harness.core();
