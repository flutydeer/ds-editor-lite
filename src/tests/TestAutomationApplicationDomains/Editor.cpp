...
void TestAutomationApplicationDomains::editorViewCommands_data() {
...
void TestAutomationApplicationDomains::editorViewCommands() {
...
void TestAutomationApplicationDomains::unavailableEditorView() {
...
void TestAutomationApplicationDomains::editorPreferencesPreserveDocument() {
    ApplicationHarness harness;
    auto &runtime = harness.core();
...
void TestAutomationApplicationDomains::editorSelectionAndSnapshots() {
    ApplicationHarness harness;
    auto &runtime = harness.core();
...
void TestAutomationApplicationDomains::editorSelectionRoutingErrors() {
    ApplicationHarness harness;
    auto &runtime = harness.core();
...
void TestAutomationApplicationDomains::editorRevealAndRangeFallback() {
    ApplicationHarness harness;
    auto &runtime = harness.core();
    const auto objects = createEditorObjects(harness);
    QVERIFY(objects);
