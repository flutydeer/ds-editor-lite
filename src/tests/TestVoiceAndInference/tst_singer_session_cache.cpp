...
void VoiceAndInferenceTests::singerSessionCacheRetainsOnlySelectedSingers() {
    FakeClock::reset();
    int creationCount = 0;
...
void VoiceAndInferenceTests::singerSessionCacheLatestRetainedIdentifiers() {
    FakeCache cache;
    const auto firstIdentifier = makeIdentifier(QStringLiteral("first"));
    const auto secondIdentifier = makeIdentifier(QStringLiteral("second"));
...
void VoiceAndInferenceTests::singerSessionCacheActiveCallerAndStaleReplacement() {
    FakeClock::reset();
    int creationCount = 0;
    int destroyedCount = 0;
    FakeCache cache;
...
void VoiceAndInferenceTests::singerSessionCacheLeastRecentlyUsedEviction() {
    FakeClock::reset();
    int creationCount = 0;
    int destroyedCount = 0;
    FakeCache cache;
...
void VoiceAndInferenceTests::singerSessionCacheIdleEvictionAndActiveReuse() {
    FakeClock::reset();
    int creationCount = 0;
    int destroyedCount = 0;
    FakeCache cache;
