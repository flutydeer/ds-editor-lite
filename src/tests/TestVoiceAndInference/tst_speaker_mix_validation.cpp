...
void VoiceAndInferenceTests::inputConversionAvailableSpeakersFillEmptyMix_data() {
...
void VoiceAndInferenceTests::inputConversionAvailableSpeakersFillEmptyMix() {
...
void VoiceAndInferenceTests::inputConversionAvailableMixIsPreserved() {
...
void VoiceAndInferenceTests::inputConversionUnavailableSourcesAreRemoved() {
...
void VoiceAndInferenceTests::inputConversionUnusableMixFallsBackToAvailableSpeaker_data() {
...
void VoiceAndInferenceTests::inputConversionUnusableMixFallsBackToAvailableSpeaker() {
...
void VoiceAndInferenceTests::inputConversionUnavailablePrimaryIsReplaced() {
    const auto mix = twoSpeakerMix();
...
void VoiceAndInferenceTests::inputConversionUnresolvedSpeakerMetadataPreservesInput() {
...
void VoiceAndInferenceTests::inputConversionSurvivingMixCurvesAreRenormalized() {
    InferSpeakerMix mix;
