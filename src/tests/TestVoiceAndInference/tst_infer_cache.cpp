...
void VoiceAndInferenceTests::inferCacheScanAndClean() {
    QTemporaryDir dir;
    ...
    QVERIFY(writeFile("infer-acoustic-output-aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa.wav", 1000));
    QVERIFY(writeFile("infer-acoustic-input-aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa.json", 200));
    QVERIFY(writeFile("infer-duration-output-bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb.json", 300));
...
void VoiceAndInferenceTests::inferCacheClearRegisteredFiles() {
