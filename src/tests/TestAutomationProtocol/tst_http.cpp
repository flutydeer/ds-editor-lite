...
void AutomationProtocolTests::modernClientIdentity() {
...
void AutomationProtocolTests::legacySessionLifecycle() {
    McpServerFixture fixture;
    QVERIFY2(fixture.start(), qPrintable(fixture.error));
    auto &server = fixture.server;
    auto &manager = fixture.manager;
...
void AutomationProtocolTests::httpAdmission_data() {
...
void AutomationProtocolTests::httpAdmission() {
...
void AutomationProtocolTests::emptyOriginRejected() {
    McpServerFixture fixture;
    QVERIFY2(fixture.start(), qPrintable(fixture.error));
    auto &server = fixture.server;
    auto &manager = fixture.manager;
...
void AutomationProtocolTests::transportMetadataRouting() {
    McpServerFixture fixture;
    QVERIFY2(fixture.start(), qPrintable(fixture.error));
    auto &server = fixture.server;
    auto &manager = fixture.manager;
...
void AutomationProtocolTests::jsonAndRequestLimits() {
    McpServerFixture fixture;
    QVERIFY2(fixture.start(), qPrintable(fixture.error));
    auto &server = fixture.server;
    auto &manager = fixture.manager;
...
void AutomationProtocolTests::responseSurvivesShutdown() {
...
void AutomationProtocolTests::nativeRequestValidation() {
...
void AutomationProtocolTests::nativeMcpRouteLifecycle() {
    NativeServerFixture fixture;
    QVERIFY2(fixture.start(), qPrintable(fixture.error));
    auto &dualProtocolServer = fixture.server;
    const auto &dualProtocolLimits = fixture.limits;
...
void AutomationProtocolTests::defaultRequestDeadline() {
    QNetworkAccessManager manager;
    manager.setProxy(QNetworkProxy::NoProxy);
...
void AutomationProtocolTests::sharedAdmissionAndDeadline() {
    QNetworkAccessManager manager;
    manager.setProxy(QNetworkProxy::NoProxy);
    const Mcp::ImplementationInfo serverInfo{
        QStringLiteral("DS Editor Lite Test"), QStringLiteral("1.0"), {}, {}};
...
void AutomationProtocolTests::crossConnectionCancellation_data() {
    QTest::addColumn<bool>("legacy");
    QTest::newRow("modern") << false;
    QTest::newRow("legacy") << true;
}

void AutomationProtocolTests::crossConnectionCancellation() {
    QFETCH(bool, legacy);
    QNetworkAccessManager manager;
    manager.setProxy(QNetworkProxy::NoProxy);
    const Mcp::ImplementationInfo serverInfo{
