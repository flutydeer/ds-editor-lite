...
void AutomationProtocolTests::routing_data() {
...
void AutomationProtocolTests::routing() {
...
void AutomationProtocolTests::rejectedInputs_data() {
...
void AutomationProtocolTests::rejectedInputs() {
...
void AutomationProtocolTests::sharedEditingScenario_data() {
    QTest::addColumn<QString>("adapter");
    for (const auto *name : {"facade", "registry", "native", "mcp"})
        QTest::newRow(name) << QString::fromLatin1(name);
}

void AutomationProtocolTests::sharedEditingScenario() {
