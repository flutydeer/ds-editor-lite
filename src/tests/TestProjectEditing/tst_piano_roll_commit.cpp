...
void ProjectEditingTests::insertReturnsCommittedNote() {
    ...
    QVERIFY2((insertedSnapshot && insertedSnapshot->data.localStart == 0 &&
...
void ProjectEditingTests::rejectedInsertPreservesDocument() {
    AutomationTestSupport::TestRuntime testRuntime;
    auto &runtime = testRuntime.runtime();
    const auto fixture = createFixture(runtime);
    QVERIFY(fixture.has_value());
...
void ProjectEditingTests::splitReturnsCommittedChild() {
    AutomationTestSupport::TestRuntime testRuntime;
    auto &runtime = testRuntime.runtime();
    const auto fixture = createFixture(runtime);
    QVERIFY(fixture.has_value());
...
void ProjectEditingTests::rejectedSplitPreservesDocument() {
    AutomationTestSupport::TestRuntime testRuntime;
    auto &runtime = testRuntime.runtime();
    const auto fixture = createFixture(runtime);
    QVERIFY(fixture.has_value());
