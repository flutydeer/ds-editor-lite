...
namespace {
    ...
    void testDisplayModeMapping() {
        ...
        expect(PitchDisplayStrategy::displayModeForEditMode(ScalePitch) == PitchDisplayMode::Draw,
               "scale mode must use the draw pitch presentation");
    ...
    void testPitchEditModeClassification() {
        ...
        expect(isPitchEditMode(ScalePitch), "pitch scale mode must edit pitch");
    }
