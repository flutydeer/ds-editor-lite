...
void EditorRenderingTests::fractionalDprAndTextureReplacement() {
    QFont font(QStringLiteral("Arial"));
    font.setPixelSize(12);
    const QFontMetricsF metrics(font);
    QString text;
    ...
    if (fractionalBatches.size() == 1 && fractionalBatches.front().vertices.size() == 6) {
        ...
        QVERIFY2(
            (clearedBatches.size() == 1 && clearedBatches.front().generation > previousGeneration),
            "clearing an atlas must force a replacement texture upload");
    }
}

void EditorRenderingTests::subpixelPhaseCache() {
    QFont font(QStringLiteral("Arial"));
    font.setPixelSize(12);
    const QFontMetricsF metrics(font);
    QString text;
...
void EditorRenderingTests::cameraRelativeAlignment() {
    QFont font(QStringLiteral("Arial"));
    font.setPixelSize(12);
    const QFontMetricsF metrics(font);
    QString text;
...
void EditorRenderingTests::windowRelativeAlignment() {
    QFont font(QStringLiteral("Arial"));
    font.setPixelSize(12);
    const QFontMetricsF metrics(font);
    QString text;
...
void EditorRenderingTests::drawOrderPreservesOcclusion() {
    QFont font(QStringLiteral("Arial"));
    font.setPixelSize(12);
    const QFontMetricsF metrics(font);
    QString text;
...
void EditorRenderingTests::blendColorsRemainDistinct() {
    QFont font(QStringLiteral("Arial"));
    font.setPixelSize(12);
    const QFontMetricsF metrics(font);
    QString text;
...
void EditorRenderingTests::currentFramePagesAreNotEvicted() {
    QFont font(QStringLiteral("Arial"));
    font.setPixelSize(12);
    const QFontMetricsF metrics(font);
    QString text;
