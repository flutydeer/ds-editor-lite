...
void ProcessIntegrationTests::editingWorkflow() {
    QVERIFY(runEditingWorkflow(editorPath, connectorPath));
}

void ProcessIntegrationTests::secondaryStartup() {
    QVERIFY(runSecondaryStartup(editorPath, connectorPath));
}

void ProcessIntegrationTests::legacyConnector() {
    QVERIFY(runLegacyConnector(editorPath, connectorPath));
}

void ProcessIntegrationTests::legacyEditor() {
    QVERIFY(runLegacyEditor(editorPath, connectorPath));
}

void ProcessIntegrationTests::documentLifecycle() {
