...
namespace PublicAutomationToolsetExpectations {
    ...
    inline const QList<EditorTool> &editorTools() {
        ...
        static const QList<EditorTool> tools{
            ...
            {QStringLiteral("documents.list_recent"),                     QStringLiteral("documents"),
             AutomationProfile::L2                                                                                            },
            ...
            {QStringLiteral("tracks.clear_voice"),                        QStringLiteral("tracks"),      AutomationProfile::L1},
            ...
            {QStringLiteral("speaker_mix.keyframes.remove"),              QStringLiteral("speaker_mix"),
             AutomationProfile::L1                                                                                            },
            {QStringLiteral("speaker_mix.presets.list"),                  QStringLiteral("speaker_mix"),
             AutomationProfile::L2                                                                                            },
            {QStringLiteral("speaker_mix.presets.save"),                  QStringLiteral("speaker_mix"),
             AutomationProfile::L2                                                                                            },
            {QStringLiteral("speaker_mix.presets.delete"),                QStringLiteral("speaker_mix"),
             AutomationProfile::L2                                                                                            },
            ...
            {QStringLiteral("parameters.get_capabilities"),               QStringLiteral("parameters"),
             AutomationProfile::L1                                                                                            },
            {QStringLiteral("parameters.get"),                            QStringLiteral("parameters"),  AutomationProfile::L1},
            ...
            {QStringLiteral("parameters.bake"),                           QStringLiteral("parameters"),
             AutomationProfile::L1                                                                                            },
            {QStringLiteral("parameters.create_anchor_curve"),            QStringLiteral("parameters"),
             AutomationProfile::L1                                                                                            },
            {QStringLiteral("parameters.insert_anchors"),                 QStringLiteral("parameters"),
             AutomationProfile::L1                                                                                            },
            {QStringLiteral("parameters.merge_anchor_curves"),            QStringLiteral("parameters"),
             AutomationProfile::L1                                                                                            },
            ...
            {QStringLiteral("inference.get_status"),                      QStringLiteral("inference"),
             AutomationProfile::L2                                                                                            },
            {QStringLiteral("inference.start"),                           QStringLiteral("inference"),   AutomationProfile::L2},
            ...
            {QStringLiteral("workspace.get"),                             QStringLiteral("workspace"),   AutomationProfile::L3},
            {QStringLiteral("workspace.set_panel_visibility"),            QStringLiteral("workspace"),
             AutomationProfile::L3                                                                                            },

            {QStringLiteral("track_panel.get"),                           QStringLiteral("track_panel"),
             AutomationProfile::L3                                                                                            },
            {QStringLiteral("track_panel.set_viewport"),                  QStringLiteral("track_panel"),
             AutomationProfile::L3                                                                                            },
            {QStringLiteral("track_panel.reveal_clips"),                  QStringLiteral("track_panel"),
             AutomationProfile::L3                                                                                            },
            {QStringLiteral("track_panel.set_auto_page_turn"),            QStringLiteral("track_panel"),
             AutomationProfile::L3                                                                                            },
            {QStringLiteral("track_panel.select_track"),                  QStringLiteral("track_panel"),
             AutomationProfile::L3                                                                                            },
            {QStringLiteral("track_panel.select_clips"),                  QStringLiteral("track_panel"),
             AutomationProfile::L3                                                                                            },
            {QStringLiteral("track_panel.clear_selection"),               QStringLiteral("track_panel"),
             AutomationProfile::L3                                                                                            },

            {QStringLiteral("clip_editor.get"),                           QStringLiteral("clip_editor"),
             AutomationProfile::L3                                                                                            },
            {QStringLiteral("clip_editor.set_active_clip"),               QStringLiteral("clip_editor"),
             AutomationProfile::L3                                                                                            },
            {QStringLiteral("clip_editor.set_time_viewport"),             QStringLiteral("clip_editor"),
             AutomationProfile::L3                                                                                            },
            {QStringLiteral("clip_editor.set_auto_page_turn"),            QStringLiteral("clip_editor"),
             AutomationProfile::L3                                                                                            },
            {QStringLiteral("clip_editor.show_region"),                   QStringLiteral("clip_editor"),
             AutomationProfile::L3                                                                                            },
            {QStringLiteral("clip_editor.piano.set_pitch_viewport"),      QStringLiteral("clip_editor"),
             AutomationProfile::L3                                                                                            },
            {QStringLiteral("clip_editor.piano.reveal_notes"),            QStringLiteral("clip_editor"),
             AutomationProfile::L3                                                                                            },
            {QStringLiteral("clip_editor.piano.set_edit_mode"),           QStringLiteral("clip_editor"),
             AutomationProfile::L3                                                                                            },
            {QStringLiteral("clip_editor.piano.set_quantize"),            QStringLiteral("clip_editor"),
             AutomationProfile::L3                                                                                            },
            {QStringLiteral("clip_editor.piano.select_notes"),            QStringLiteral("clip_editor"),
             AutomationProfile::L3                                                                                            },
            {QStringLiteral("clip_editor.piano.clear_selection"),         QStringLiteral("clip_editor"),
             AutomationProfile::L3                                                                                            },
            {QStringLiteral("clip_editor.parameters.set_foreground"),     QStringLiteral("clip_editor"),
             AutomationProfile::L3                                                                                            },
            {QStringLiteral("clip_editor.parameters.set_background"),     QStringLiteral("clip_editor"),
             AutomationProfile::L3                                                                                            },
            {QStringLiteral("clip_editor.parameters.swap"),               QStringLiteral("clip_editor"),
             AutomationProfile::L3                                                                                            },
            {QStringLiteral("clip_editor.parameters.set_tool"),           QStringLiteral("clip_editor"),
             AutomationProfile::L3                                                                                            },
            {QStringLiteral("clip_editor.parameters.set_value_viewport"),
             QStringLiteral("clip_editor"),                                                              AutomationProfile::L3},

            {QStringLiteral("settings.query"),                            QStringLiteral("settings"),    AutomationProfile::L3},
            {QStringLiteral("settings.ui_language.update"),               QStringLiteral("settings"),
             AutomationProfile::L3                                                                                            },
            {QStringLiteral("settings.singing.update"),                   QStringLiteral("settings"),
             AutomationProfile::L3                                                                                            },
            {QStringLiteral("settings.theme.update"),                     QStringLiteral("settings"),
             AutomationProfile::L3                                                                                            },
            {QStringLiteral("settings.audio_device.update"),              QStringLiteral("settings"),
             AutomationProfile::L3                                                                                            },
            {QStringLiteral("settings.playback_behavior.update"),         QStringLiteral("settings"),
             AutomationProfile::L3                                                                                            },
            {QStringLiteral("settings.compute_device.update"),            QStringLiteral("settings"),
             AutomationProfile::L3                                                                                            },
            {QStringLiteral("settings.render.update"),                    QStringLiteral("settings"),
             AutomationProfile::L3                                                                                            },
            {QStringLiteral("settings.singer_session_retention.update"),  QStringLiteral("settings"),
             AutomationProfile::L3                                                                                            },
            {QStringLiteral("settings.package_search_paths.update"),      QStringLiteral("settings"),
             AutomationProfile::L3                                                                                            },

            {QStringLiteral("packages.list"),                             QStringLiteral("packages"),    AutomationProfile::L3},
            {QStringLiteral("packages.describe"),                         QStringLiteral("packages"),
             AutomationProfile::L3                                                                                            },
            {QStringLiteral("packages.refresh"),                          QStringLiteral("packages"),    AutomationProfile::L3},

            {QStringLiteral("lyric_rules.list"),                          QStringLiteral("lyric_rules"),
             AutomationProfile::L3                                                                                            },
            {QStringLiteral("lyric_rules.create"),                        QStringLiteral("lyric_rules"),
             AutomationProfile::L3                                                                                            },
            {QStringLiteral("lyric_rules.update"),                        QStringLiteral("lyric_rules"),
             AutomationProfile::L3                                                                                            },
            {QStringLiteral("lyric_rules.delete"),                        QStringLiteral("lyric_rules"),
             AutomationProfile::L3                                                                                            },
            {QStringLiteral("lyric_rules.set_enabled"),                   QStringLiteral("lyric_rules"),
             AutomationProfile::L3                                                                                            },
            {QStringLiteral("lyric_rules.move"),                          QStringLiteral("lyric_rules"),
             AutomationProfile::L3                                                                                            },
            {QStringLiteral("lyric_rules.test"),                          QStringLiteral("lyric_rules"),
             AutomationProfile::L3                                                                                            },
        };
        return tools;
    }
