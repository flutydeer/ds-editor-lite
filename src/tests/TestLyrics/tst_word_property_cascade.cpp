...
void LyricsTests::wordPropertyCascadeLyricChangeResetsPronunciationAndPhonemes() {
    testLyricChangeResetsPronunciationAndPhonemes();
}

void LyricsTests::wordPropertyCascadePronunciationChangeResetsPhonemes() {
    testPronunciationChangeResetsPhonemes();
}

void LyricsTests::wordPropertyCascadeUnchangedUpperPropertiesPreservePhonemes() {
    testUnchangedUpperPropertiesPreservePhonemes();
}

void LyricsTests::wordPropertyCascadeEquivalentPronunciationPreservesPhonemes() {
    testEquivalentPronunciationPreservesPhonemes();
}

void LyricsTests::wordPropertyCascadeEqualFillLyricReplacementsArePreserved() {
