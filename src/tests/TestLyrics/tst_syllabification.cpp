...
void LyricsTests::syllabificationSlicerSyllableAssignment() {
    testSlicerSyllableAssignment();
}

void LyricsTests::syllabificationSlicerAssignmentRecovery() {
    testSlicerAssignmentRecovery();
}

void LyricsTests::syllabificationStorageAndInferenceRoundTrip() {
    testStorageAndInferenceRoundTrip();
}

void LyricsTests::syllabificationDetachedSyllabificationNotesStayOrphaned() {
    testDetachedSyllabificationNotesStayOrphaned();
}

void LyricsTests::syllabificationBuildWordsRejectsPendingOffsets() {
    testBuildWordsRejectsPendingOffsets();
}

void LyricsTests::syllabificationEditingEligibility() {
    testEditingEligibility();
}

void LyricsTests::syllabificationRelativeTimingChangeInvalidatesEditedOffsets() {
    testRelativeTimingChangeInvalidatesEditedOffsets();
}

void LyricsTests::syllabificationTempoAwareWordState() {
    testTempoAwareWordState();
}

void LyricsTests::syllabificationCascadeResetClosure() {
    testCascadeResetClosure();
}

void LyricsTests::syllabificationCascadeResetStopsWithoutOverlap() {
    testCascadeResetStopsWithoutOverlap();
}

void LyricsTests::syllabificationCascadeResetOnlyEdited() {
    testCascadeResetOnlyEdited();
}

void LyricsTests::syllabificationCascadeResetMultiStep() {
    testCascadeResetMultiStep();
}

void LyricsTests::syllabificationCascadeResetStopsAtGap() {
    testCascadeResetStopsAtGap();
}

void LyricsTests::syllabificationCascadeResetWordEndThroughMembers() {
    testCascadeResetWordEndThroughMembers();
}

void LyricsTests::syllabificationCascadeResetSkippedWithoutBaseline() {
