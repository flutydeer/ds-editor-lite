...
namespace {
    ...
    class TestAutomationWire final : public QObject {
        Q_OBJECT
    ...
    void TestAutomationWire::canonicalJsonEncoding() {
    ...
    void TestAutomationWire::jsonSchema() {
        ...
        expect(checkJsonSchema(cyclicReference).valid() && !cyclicResult.valid() &&
        ...
        expect(checkJsonSchema(safeCardinality).valid() &&
                   !checkJsonSchema(unsafeCardinality).valid(),
    ...
    void TestAutomationWire::exposurePolicy() {
    ...
    void TestAutomationWire::mcpProtocol() {
        ...
        expect(!validateResponse(missingResultId).valid() &&
                   !validateResponse(nullResultId).valid() &&
        ...
        expect(parseError.value(QStringLiteral("id")).isNull() &&
...
QTEST_GUILESS_MAIN(TestAutomationWire)
#include "main.moc"
