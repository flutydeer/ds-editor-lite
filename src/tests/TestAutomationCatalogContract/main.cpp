...
#define EXPECTED_DESCRIPTOR(idValue, scenarioValue, categoryValue, kindValue, syncValue,           \
    ...
    const QList<ExpectedOperation> kExpectedOperations{
        ...
        EXPECTED_DESCRIPTOR(editor::center_track_panel, "AFC-CATALOG-020", "editor", Command,
                            Synchronous, None, None, None, None, GuiOnly, Reversible, InternalOnly,
                            Unsupported),
        EXPECTED_DESCRIPTOR(editor::focus_region, "AFC-CATALOG-198", "editor", Command, Synchronous,
        ...
        EXPECTED_DESCRIPTOR(editor::set_auto_page_turn, "AFC-CATALOG-026", "editor", Command,
                            Synchronous, None, None, None, None, GuiOnly, Reversible, InternalOnly,
                            Unsupported),
        EXPECTED_DESCRIPTOR(editor::set_clip_editor_time_viewport, "AFC-CATALOG-199", "editor",
                            Command, Synchronous, None, None, None, None, GuiOnly, Reversible,
                            InternalOnly, Unsupported),
        EXPECTED_DESCRIPTOR(editor::set_panel_visibility, "AFC-CATALOG-027", "editor", Command,
                            Synchronous, None, None, None, None, GuiOnly, Reversible, InternalOnly,
                            Unsupported),
        EXPECTED_DESCRIPTOR(editor::set_parameter_background, "AFC-CATALOG-200", "editor", Command,
                            Synchronous, Read, Check, None, None, GuiOnly, Reversible, InternalOnly,
                            Unsupported),
        EXPECTED_DESCRIPTOR(editor::set_parameter_edit_mode, "AFC-CATALOG-201", "editor", Command,
                            Synchronous, Read, Check, None, None, GuiOnly, Reversible, InternalOnly,
                            Unsupported),
        EXPECTED_DESCRIPTOR(editor::set_parameter_foreground, "AFC-CATALOG-202", "editor", Command,
                            Synchronous, Read, Check, None, None, GuiOnly, Reversible, InternalOnly,
                            Unsupported),
        EXPECTED_DESCRIPTOR(editor::set_parameter_value_viewport, "AFC-CATALOG-203", "editor",
                            Command, Synchronous, Read, Check, None, None, GuiOnly, Reversible,
                            InternalOnly, Unsupported),
        EXPECTED_DESCRIPTOR(editor::set_piano_roll_edit_mode, "AFC-CATALOG-028", "editor", Command,
                            Synchronous, None, None, None, None, GuiOnly, Reversible, InternalOnly,
                            Unsupported),
        EXPECTED_DESCRIPTOR(editor::set_piano_roll_pitch_viewport, "AFC-CATALOG-204", "editor",
                            Command, Synchronous, None, None, None, None, GuiOnly, Reversible,
                            InternalOnly, Unsupported),
        ...
        EXPECTED_DESCRIPTOR(editor::set_track_panel_scale, "AFC-CATALOG-032", "editor", Command,
                            Synchronous, None, None, None, None, GuiOnly, Reversible, InternalOnly,
                            Unsupported),
        EXPECTED_DESCRIPTOR(editor::set_track_panel_viewport, "AFC-CATALOG-205", "editor", Command,
                            Synchronous, None, None, None, None, GuiOnly, Reversible, InternalOnly,
                            Unsupported),
        EXPECTED_DESCRIPTOR(editor::show_bottom_panel_page, "AFC-CATALOG-033", "editor", Command,
                            Synchronous, None, None, None, None, GuiOnly, Reversible, InternalOnly,
                            Unsupported),
        EXPECTED_DESCRIPTOR(editor::show_region, "AFC-CATALOG-206", "editor", Command, Synchronous,
                            None, None, None, None, GuiOnly, Reversible, InternalOnly, Unsupported),
        EXPECTED_DESCRIPTOR(editor::swap_parameters, "AFC-CATALOG-207", "editor", Command,
                            Synchronous, Read, Check, None, None, GuiOnly, Reversible, InternalOnly,
                            Unsupported),
        ...
        EXPECTED_DESCRIPTOR(notes::insert, "AFC-CATALOG-059", "notes", Command, Synchronous, Write,
                            Increment, Record, None, Core, Reversible, InternalOnly,
                            DocumentGeneration),
        EXPECTED_DESCRIPTOR(notes::list, "AFC-CATALOG-058", "notes", Query, Synchronous, Read, None,
                            None, None, Core, ReadOnly, InternalOnly, Unsupported),
        ...
        EXPECTED_DESCRIPTOR(packages::list, "AFC-CATALOG-072", "packages", Query, Synchronous, None,
                            None, None, None, Core, ReadOnly, InternalOnly, Unsupported),
        EXPECTED_DESCRIPTOR(packages::refresh, "AFC-CATALOG-208", "packages", Command, Asynchronous,
                            None, None, None, Read, Core, FileSystem, InternalOnly, Unsupported),
        ...
        EXPECTED_DESCRIPTOR(recent_files::remove, "AFC-CATALOG-091", "recent_files", Command,
                            Synchronous, None, None, None, Write, Core, Reversible, InternalOnly,
                            Unsupported),
        EXPECTED_DESCRIPTOR(settings::query, "AFC-CATALOG-092", "settings", Query, Synchronous,
        ...
        EXPECTED_DESCRIPTOR(tasks::list, "AFC-CATALOG-070", "tasks", Query, Synchronous, Read, None,
                            None, None, Core, ReadOnly, InternalOnly, Unsupported),
        EXPECTED_DESCRIPTOR(tempos::remove, "AFC-CATALOG-112", "tempos", Command, Synchronous,
                            Write, Increment, Record, None, Core, Reversible, InternalOnly,
                            DocumentGeneration),
        EXPECTED_DESCRIPTOR(tempos::set, "AFC-CATALOG-113", "tempos", Command, Synchronous, Write,
                            Increment, Record, None, Core, Reversible, InternalOnly,
                            DocumentGeneration),
        EXPECTED_DESCRIPTOR(time_signatures::remove, "AFC-CATALOG-114", "time_signatures", Command,
                            Synchronous, Write, Increment, Record, None, Core, Reversible,
                            InternalOnly, DocumentGeneration),
...
int main(int argc, char *argv[]) {
    ...
    bool ok = true;
    ok &= expect(kExpectedOperations.size() == 208,
                 QStringLiteral("the explicit descriptor table must contain 208 operations"));
