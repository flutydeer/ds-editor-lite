...
function(vcpkg_cmake_configure)
    ...
    if(DEFINED ENV{VCPKG_CMAKE_RELEASE_BUILD_TYPE})
        set(rel_build_type $ENV{VCPKG_CMAKE_RELEASE_BUILD_TYPE})
    else()
        set(rel_build_type Release)
    endif()

    if(DEFINED ENV{VCPKG_CMAKE_DEBUG_BUILD_TYPE})
        set(dbg_build_type $ENV{VCPKG_CMAKE_DEBUG_BUILD_TYPE})
    else()
        set(dbg_build_type Debug)
    endif()
    ...
    vcpkg_list(SET rel_command
        ...
        "-DCMAKE_BUILD_TYPE=${rel_build_type}"
    ...
    vcpkg_list(SET dbg_command
        ...
        -G "${generator}"
        ${architecture_options}
        "-DCMAKE_BUILD_TYPE=${dbg_build_type}"
